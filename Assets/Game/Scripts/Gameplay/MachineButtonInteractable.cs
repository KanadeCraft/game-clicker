...
public class MachineButtonInteractable : MonoBehaviour
{
    [SerializeField]
    ...
    void Start()
    {
        ...
        GameManager.Instance.OnMachineCostChanged += OnCostChanged;
    }
    ...
    {
        button.interactable = GameManager.Instance.CanBuyMachine();
    }
